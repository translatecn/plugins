...
func tidyRules(iface string) error {
	...
	if err != nil {
		...
		// https://github.com/containernetworking/plugins/3rd/containernetworking/cni/blob/main/SPEC.md#del-remove-container-from-network-or-un-apply-modifications
