...
import (
	...
	"github.com/containernetworking/plugins/plugins/ipam/over/host-local/backend/allocator"
...
func cmdAdd(args *skel.CmdArgs) error {
	...
	//				"ipam": {
	//					"type": "host-local",
	//					"dataDir": "/tmp/host-local_test3738729532",
	//					"resolvConf": "/tmp/host-local_test3738729532/resolv.conf",
	//					"ranges": [
